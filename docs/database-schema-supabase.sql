-- =====================================================
-- KORSVAGEN WEB APPLICATION - DATABASE SCHEMA (SUPABASE)
-- =====================================================
-- 
-- Schema SQL ottimizzato per Supabase senza permessi speciali
-- Rimuove le configurazioni che richiedono privilegi di superuser
--
...
INSERT INTO admin_users (
    ...
    'admin',
    'admin@korsvagen.it',
    '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewTYfPV1OJqjQ0sW',
    'super_admin',
    '{
...
-- Inserimento secondo utente amministratore
-- Username: korsvagen_admin, Password: "Korsvagen1234!"
INSERT INTO admin_users (
    username, 
    email, 
    password_hash, 
    ...
    'korsvagen_admin',
    'korsvagen@admin.it',
    '$2b$12$Uf4.zBGWmHtJVFwal7uJW.XZyVOkkQ9v5jfSZ9CGzu2afFXJ.KyHO',
    'super_admin',
    '{
        "firstName": "Admin",
        "lastName": "Korsvagen",
